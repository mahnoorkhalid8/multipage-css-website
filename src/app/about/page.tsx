...
const About = () => {
  return (
    <div>
      <section className='about-us' style={{backgroundImage:"url(about-bg.png)"}}>
        <div className='about'>
          ...
          <p>Step into Confidence with Our Exclusive
            ...
            designs, premium materials, and unmatched
            durability crafted for your perfect fit. Walk
            with style, stride with confidence!</p>
        </div>
      </section>
    </div>
  )
